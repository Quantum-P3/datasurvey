...
!(function (a) {
  ...
  function S(c, e, i) {
    ...
    function M(a, b, c, d, f) {
      return (
        ba.length > 1 &&
          (d && b > 0 && (c = Math.max(c, a[b - 1] + e.margin)), f && b < ba.length - 1 && (c = Math.min(c, a[b + 1] - e.margin))),
        ba.length > 1 &&
          e.limit &&
          (d && b > 0 && (c = Math.min(c, a[b - 1] + e.limit)), f && b < ba.length - 1 && (c = Math.max(c, a[b + 1] - e.limit))),
        e.padding && (0 === b && (c = Math.max(c, e.padding)), b === ba.length - 1 && (c = Math.min(c, 100 - e.padding))),
        (c = ja.getStep(c)),
        (c = g(c)),
        c !== a[b] && c
      );
    ...
    function T(a, b) {
      null !== a &&
        a !== !1 &&
        ('number' == typeof a && (a = String(a)), (a = e.format.from(a)), a === !1 || isNaN(a) || Q(b, ja.toStepping(a), !1, !1));
    }
    function U(a, b) {
      var c = h(a),
        d = void 0 === ga[0];
