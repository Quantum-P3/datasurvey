...
!(function (t, e) {
  ...
  function J(t, e, n, i) {
    return Math.max(
      ...
      n['offset' + t],
      n['scroll' + t],
      Z() ? n['offset' + t] + i['margin' + ('Height' === t ? 'Top' : 'Left')] + i['margin' + ('Height' === t ? 'Bottom' : 'Right')] : 0
    );
  }
  function $() {
    var t = document.body,
      ...
      modifiers: {
              ...
              s = {
                ...
                secondary: function (t) {
                  var n = 'right' === t ? 'left' : 'top',
                    r = o[n];
                  return (
                    o[t] > i[t] && !e.escapeWithReference && (r = Math.min(o[n], i[t] - ('right' === t ? o.width : o.height))), nt({}, n, r)
                  );
                },
              };
            return (
        ...
        inner: {
          ...
          fn: function (t) {
            ...
            return (
              (r[s ? 'left' : 'top'] = o[n] - (a ? r[s ? 'width' : 'height'] : 0)), (t.placement = ft(e)), (t.offsets.popper = rt(r)), t
            );
          },
        },
        hide: {
        ...
        N = (function () {
          ...
          return (
            ...
            (v._getConfig = function (n) {
              return (
                (n = r({}, this.constructor.Default, t(this._element).data(), n)), k.typeCheckConfig(e, n, this.constructor.DefaultType), n
              );
            }),
            ...
            (s._dataApiKeydownHandler = function (e) {
              if (
                (/input|textarea/i.test(e.target.tagName)
                  ? !(32 === e.which || (27 !== e.which && ((40 !== e.which && 38 !== e.which) || t(e.target).closest(E).length)))
                  : a.test(e.which)) &&
          ...
          return (
            ...
            (T._fixTransition = function () {
              ...
              null === e.getAttribute('x-placement') &&
                (t(e).removeClass(p), (this.config.animation = !1), this.hide(), this.show(), (this.config.animation = n));
            }),
            (s._jQueryInterface = function (e) {
              return this.each(function () {
                var i = t(this).data(n),
        ...
        _ = (function () {
          ...
          return (
            (n.show = function () {
              ...
              if (
                !(
                  (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(s)) ||
